...
1. Re-run the app and use the 'Start new conversation' button of the emulator ![](./images/scenario2-start-new.png). Test the new conversation.
    ...
    ![](./images/scenario2-full-conversation-1.png)
...
1. Add the following require statement at the top of the file.
...
1. Re-run the app and use the **Start new conversation** button of the emulator. Test the full conversation again to check that the ticket id is returned from the API.
    ...
    ![scenario2-full-conversation-2](./images/scenario2-full-conversation-2.png)
...
* You can try adding a Welcome message to the bot.
